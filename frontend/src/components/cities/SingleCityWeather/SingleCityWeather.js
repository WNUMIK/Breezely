            ...
            {weatherData && (
                <div className={styles.weatherDashboard}>
                    <div className={styles.weatherCard}>
                        ...
                        <p><span
                            className={styles.weatherCardIcon}>💧</span> Humidity: <strong>{weatherData.humidity}%</strong></p>
                                    ...
                                    return (
                                        <div key={index} className={styles.forecastCardContainer}>
                                            ...
                                            <div className={styles.infoRow}>
                                                ...
                                                <p><span className={styles.icon}>💧</span> Humidity: <strong>{forecast.humidity}%</strong></p>
                                            </div>
                                            <div className={styles.infoRow}>
